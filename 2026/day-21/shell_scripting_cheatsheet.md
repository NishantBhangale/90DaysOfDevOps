...
Output :
nishant@nishant-linux:~/practice_sh$ ./try.sh 
a=Hello	b=Hello
Check = : True
Check != : False
...
OutPut:
nishant@nishant-linux:~/practice_sh$ ./br_cnt.sh 
...
```
add() {
        local name="Nishant" #local variable
