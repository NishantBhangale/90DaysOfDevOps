...
1. **GitFlow** — 
   ...
   - **hotfix** : Created from master to fix urgent bugs. Changes are merged back into both master and develop.
     ...
     <img width="1065" height="712" alt="image" src="https://github.com/user-attachments/assets/b47150c1-d640-4878-872b-acd69544f6c2" />
...
2. **Trunk-Based Development** — everyone commits to main, short-lived branches
